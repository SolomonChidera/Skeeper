...
const motivationalMessages = [
  ...
  'You start healing yourself before other can help',
  'Pray and Work'
...
function sendMotivationalMessage () {
  const channel = client.channels.cache.get(config.chanelID); // 'chanelID' with the ID of the channel where you want to send the message
  if (channel) {
...
const frozenUsers = new Set(); // for frozen users

// Function to check if a message is spam
function isSpam (message) {
  // Defined spam threshold, warning threshold, and freeze threshold
